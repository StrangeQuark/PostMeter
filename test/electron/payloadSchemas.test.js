...
test('defines shared payload schema metadata for IPC and contributors', () => {
  ...
  assert.equal(payloadSchemas.fields.updateCheckOptions.automaticUpdatesEnabled.type, 'boolean');
  assert.equal(payloadSchemas.fields.updateCheckOptions.includePrereleases.type, 'boolean');
  assert.equal(payloadSchemas.fields.updateCheckOptions.startupRemindersEnabled.type, 'boolean');
