...
- A generated Postman sandbox parity matrix is committed at `docs/postman-sandbox-parity-matrix.json`, with source in `src/core/diagnostics-release/postmanParityMatrix.js`, currently tracking 406 Postman API, method, property, global, module, protocol, fixture, claim-gate, and security-decision rows against the targeted `newman@6.2.2` release.
