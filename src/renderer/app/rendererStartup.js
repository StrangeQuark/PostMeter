...
function bindUi() {
  ...
  bindRendererUi({
    ...
    onNewWorkspace: () => { void (activeWorkspaceLocked() ? newWorkspaceFromLockedGate() : newWorkspace()); },
    onNewWorkspaceFromLockedGate: () => { void newWorkspaceFromLockedGate(); },
    onUnlockActiveWorkspace: () => { void unlockWorkspace(activeWorkspaceId, { focus: 'workspace' }); },
    onSwitchWorkspaceFromLockedGate: () => switchWorkspaceFromLockedGate(),
    ...
    onClearClientCertificateCertPath: () => clearClientCertificatePath('cert'),
    onClearClientCertificateKeyPath: () => clearClientCertificatePath('key'),
    onClearClientCertificatePfxPath: () => clearClientCertificatePath('pfx'),
