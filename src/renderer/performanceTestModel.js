(function attachPerformanceTestModel(global) {
  ...
  function normalizeAuthRefreshConfig(authRefresh = {}) {
    ...
    return {
      ...
      apiKeyLocation: ['header', 'query'].includes(String(input.apiKeyLocation || '')) ? String(input.apiKeyLocation) : DEFAULT_AUTH_REFRESH.apiKeyLocation,
      apiKeyName: normalizeAuthRefreshText(input.apiKeyName, DEFAULT_AUTH_REFRESH.apiKeyName, 512),
