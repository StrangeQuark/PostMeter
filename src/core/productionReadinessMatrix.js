...
function buildProductionReadinessMatrix() {
  const rows = [
    ...
    row('vault.per-request-prompts', 'security', 'Per-request vault prompt decisions are brokered without exposing vault secrets to scripts or renderer APIs.', 'implemented', {
      releaseBlocking: true,
      commands: ['npm test'],
      evidenceRefs: ['src/core/scriptSandbox.js', 'src/core/scriptedRequestLifecycle.js', 'src/core/collectionRunner.js', 'electron/vaultPrompt.js', 'electron/requestIpc.js', 'electron/runtimeIpc.js', 'src/renderer/index.html', 'src/renderer/rendererBootstrap.js', 'src/renderer/vaultPromptQueue.js', 'docs/TROUBLESHOOTING.md', 'test/electron/scriptSandbox.test.js', 'test/electron/collectionRunner.test.js', 'test/electron/vaultPrompt.test.js', 'test/electron/vaultPromptQueue.test.js', 'test/electron/rendererBootstrap.test.js', 'test/electron/workspaceStore.test.js'],
    ...
    row('diagnostics.privacy', 'privacy', 'Local diagnostics and logging remain user-controlled, cloud-free, and default-deny request/response data.', 'validated', {
      ...
      evidenceRefs: ['docs/diagnostics-privacy-matrix.json', 'src/core/diagnostics.js', 'src/core/diagnosticsSettings.js', 'electron/diagnosticsIpc.js', 'electron/main.js', 'src/renderer/index.html', 'README.md', 'TECH_SPECS.MD', 'docs/RELEASE_READINESS.md', 'docs/TROUBLESHOOTING.md'],
