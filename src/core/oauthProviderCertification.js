...
function buildOAuthProviderCertificationMatrix() {
  return {
    schemaVersion: 1,
    generatedFrom: 'src/core/oauthProviderCertification.js',
    deterministic: true,
    providers: [
...
function validateOAuthProviderCertificationMatrix(matrix = buildOAuthProviderCertificationMatrix()) {
  ...
  if (matrix.generatedFrom !== 'src/core/oauthProviderCertification.js') {
    errors.push('OAuth provider certification matrix generatedFrom must be src/core/oauthProviderCertification.js.');
  }
