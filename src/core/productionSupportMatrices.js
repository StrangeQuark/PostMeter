...
const ELECTRON_IPC_CHANNELS = Object.freeze([
  ...
  ipcChannel('runner:export', 'renderer-to-main', 'Collection-run export validates result/format payloads before a main-process save picker and streams store-backed CSV/JSON exports from the current runtime result store.', ['electron/runtimeIpc.js', 'electron/preload.js', 'electron/fileDialogs.js', 'src/core/ipcValidation.js', 'src/core/runtimeResultStore.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/ipcValidation.test.js', 'test/electron/runtimeResultStore.test.js']),
  ...
  ipcChannel('performance:exportResult', 'renderer-to-main', 'Performance-result export validates bounded run output before writing JSON or CSV through a main-process save picker and streams store-backed exports from the current runtime result store.', ['electron/runtimeIpc.js', 'electron/preload.js', 'electron/fileDialogs.js', 'src/core/ipcValidation.js', 'src/core/performanceFormats.js', 'src/core/runtimeResultStore.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/ipcValidation.test.js', 'test/electron/performanceRunner.test.js', 'test/electron/runtimeResultStore.test.js']),
