...
const ELECTRON_IPC_CHANNELS = Object.freeze([
  ...
  ipcChannel('workspace:import', 'renderer-to-main', 'Workspace import accepts a renderer-selected local path from the shared drag/drop picker or falls back to a main-process JSON picker, then returns a validated file-operation result.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js'], ['test/electron/workspaceIpc.test.js']),
  ...
  ipcChannel('collection:import', 'renderer-to-main', 'Collection import accepts a renderer-selected local path from the shared drag/drop picker or falls back to a main-process picker constrained to supported collection formats.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/collectionFormats.test.js']),
  ...
  ipcChannel('environment:import', 'renderer-to-main', 'Environment import accepts a renderer-selected local path from the shared drag/drop picker or falls back to a JSON picker, then validates native or Postman environment payloads.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js', 'src/core/import-export/environmentFormats.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/environmentFormats.test.js']),
  ...
  ipcChannel('runner:importDefinition', 'renderer-to-main', 'Runner definition import accepts a renderer-selected local path from the shared drag/drop picker or falls back to a JSON picker, then validates native runner payloads.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js', 'src/core/import-export/runnerFormats.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/runnerFormats.test.js']),
