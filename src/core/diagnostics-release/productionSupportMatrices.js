...
const ELECTRON_IPC_CHANNELS = Object.freeze([
  ipcChannel('app:versions', 'renderer-to-main', 'Version metadata query with no renderer payload.', ['electron/ipc/appIpc.js', 'electron/app-shell/preload.js'], ['test/electron/appIpc.test.js']),
  ipcChannel('app:check-updates', 'renderer-to-main', 'Update-check request with validated prerelease options.', ['electron/ipc/appIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/appIpc.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('app:auto-update-status', 'renderer-to-main', 'Automatic update status query returns validated service state without accepting renderer update metadata.', ['electron/ipc/appIpc.js', 'electron/app-shell/preload.js', 'electron/services/autoUpdateService.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/appIpc.test.js', 'test/electron/autoUpdateService.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('app:install-update', 'renderer-to-main', 'Automatic update install request is available only after the main-process update service has downloaded a validated update.', ['electron/ipc/appIpc.js', 'electron/app-shell/preload.js', 'electron/services/autoUpdateService.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/appIpc.test.js', 'test/electron/autoUpdateService.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('app:open-external', 'renderer-to-main', 'External URL request limited to validated credential-free HTTPS GitHub URLs.', ['electron/ipc/appIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/appIpc.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('app:set-menu-shortcuts-ignored', 'renderer-to-main', 'Shortcut editor focus can temporarily suppress native menu accelerators so user-assigned shortcuts are captured in the renderer.', ['electron/ipc/appIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/mainWindow.js'], ['test/electron/appIpc.test.js', 'test/electron/mainWindowSmoke.test.js', 'test/electron/rendererBootstrap.test.js']),
  ipcChannel('clipboard:writeText', 'renderer-to-main', 'Explicit user copy actions send bounded text to the main-process clipboard API through the trusted renderer IPC wrapper.', ['electron/ipc/appIpc.js', 'electron/app-shell/preload.js', 'src/renderer/renderer.js'], ['test/electron/appIpc.test.js', 'test/electron/rendererBootstrap.test.js']),
  ipcChannel('menu:action', 'main-to-renderer', 'Native menu event delivered to the explicit preload subscription.', ['electron/main.js', 'electron/app-shell/appMenu.js', 'electron/app-shell/preload.js'], ['test/electron/appChrome.test.js']),
  ipcChannel('updates:status', 'main-to-renderer', 'Automatic update status events are validated in the main process and sanitized again by preload before renderer delivery.', ['electron/main.js', 'electron/app-shell/preload.js', 'electron/services/autoUpdateService.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/preloadMenuActions.test.js', 'test/electron/autoUpdateService.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('session:load', 'renderer-to-main', 'UI session load through the trusted renderer IPC wrapper.', ['electron/ipc/sessionIpc.js', 'electron/app-shell/preload.js'], ['test/electron/sessionIpc.test.js', 'test/electron/sessionStore.test.js']),
  ipcChannel('session:save', 'renderer-to-main', 'Asynchronous UI session save through the trusted renderer IPC wrapper.', ['electron/ipc/sessionIpc.js', 'electron/app-shell/preload.js'], ['test/electron/sessionIpc.test.js', 'test/electron/sessionStore.test.js']),
  ipcChannel('session:saveSync', 'renderer-to-main-sync', 'Synchronous shutdown UI session save through the trusted renderer IPC wrapper.', ['electron/ipc/sessionIpc.js', 'electron/app-shell/preload.js'], ['test/electron/sessionIpc.test.js', 'test/electron/sessionStore.test.js']),
  ipcChannel('workspace:load', 'renderer-to-main', 'Workspace load returns schema-validated workspace metadata.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('workspace:save', 'renderer-to-main', 'Whole-workspace save validates the workspace payload before persistence.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('workspace:saveCollection', 'renderer-to-main', 'Targeted collection save validates collection payload shape.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('workspace:saveFolder', 'renderer-to-main', 'Targeted folder save validates folder payload shape.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('workspace:saveRequest', 'renderer-to-main', 'Targeted request save validates request, variables, and cookie payload shape.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('workspace:saveEnvironment', 'renderer-to-main', 'Targeted environment save validates environment payload shape.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('workspace:saveSettings', 'renderer-to-main', 'Local settings save validates settings-only payloads, persists app-wide preferences in settings.json, and persists workspace-local preferences in managed workspace localsettings outside portable workspace exports.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js', 'src/core/workspace/appSettingsStore.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/ipcValidation.test.js', 'test/electron/appSettingsStore.test.js']),
  ipcChannel('workspace:saveSync', 'renderer-to-main-sync', 'Synchronous shutdown workspace save validates the workspace payload and skips stale full-workspace writes while queued workspace mutations are pending.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('workspace:create', 'renderer-to-main', 'Workspace creation remains main-process owned.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js'], ['test/electron/workspaceIpc.test.js']),
  ipcChannel('workspace:rename', 'renderer-to-main', 'Workspace rename validates workspace ID and bounded name input.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js'], ['test/electron/workspaceIpc.test.js']),
  ipcChannel('workspace:switch', 'renderer-to-main', 'Workspace switch validates non-empty workspace IDs before loading.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js'], ['test/electron/workspaceIpc.test.js']),
  ipcChannel('workspace:delete', 'renderer-to-main', 'Workspace delete validates non-empty workspace IDs before destructive store operations.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js'], ['test/electron/workspaceIpc.test.js']),
  ipcChannel('workspace:duplicate', 'renderer-to-main', 'Workspace duplication validates non-empty workspace IDs before creating a separate workspace file.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js'], ['test/electron/workspaceIpc.test.js']),
  ipcChannel('workspace:unlock', 'renderer-to-main', 'Encrypted workspace unlock validates workspace IDs and bounded keys before decrypting in the main process.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'src/core/workspace/workspaceEncryption.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/workspaceManager.test.js', 'test/electron/workspaceStore.test.js']),
  ipcChannel('workspace:encrypt', 'renderer-to-main', 'Workspace encryption validates workspace IDs, workspace payloads, and bounded keys before writing an encrypted workspace envelope.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'src/core/workspace/workspaceEncryption.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/workspaceManager.test.js', 'test/electron/workspaceStore.test.js']),
  ipcChannel('workspace:removeEncryption', 'renderer-to-main', 'Workspace encryption removal validates workspace IDs and bounded keys before saving the workspace as plaintext and deleting encrypted backups.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'src/core/workspace/workspaceEncryption.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/workspaceManager.test.js', 'test/electron/workspaceStore.test.js']),
  ipcChannel('workspace:resetEncryptionKey', 'renderer-to-main', 'Workspace encryption key reset validates active workspace IDs and bounded old/new keys before re-encrypting in the main process and deleting old encrypted backups.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'src/core/workspace/workspaceEncryption.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/workspaceManager.test.js', 'test/electron/workspaceStore.test.js']),
  ipcChannel('workspace:key-prompt', 'main-to-renderer', 'Workspace key prompts carry workspace metadata only and never include stored keys or workspace contents.', ['electron/ipc/workspaceKeyPrompt.js', 'electron/app-shell/preload.js'], ['test/electron/workspaceIpc.test.js']),
  ipcChannel('workspace:key-prompt-response', 'renderer-to-main', 'Workspace key prompt responses are scoped to the prompting renderer and bounded before the main process validates the key.', ['electron/ipc/workspaceKeyPrompt.js', 'electron/app-shell/preload.js', 'src/core/workspace/workspaceEncryption.js'], ['test/electron/workspaceIpc.test.js']),
  ipcChannel('workspace:import', 'renderer-to-main', 'Workspace import accepts bounded renderer-provided file contents from drag/drop or falls back to a main-process JSON picker without trusting renderer-supplied paths.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js'], ['test/electron/workspaceIpc.test.js']),
  ipcChannel('workspace:export', 'renderer-to-main', 'Workspace export validates optional workspace payload/ID before a main-process JSON save picker.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('collection:import', 'renderer-to-main', 'Collection import accepts bounded renderer-provided file contents from drag/drop or falls back to a main-process picker constrained to supported collection formats without trusting renderer-supplied paths.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/collectionFormats.test.js']),
  ipcChannel('collection:export', 'renderer-to-main', 'Collection export validates collection payload and export format before a main-process save picker.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('environment:import', 'renderer-to-main', 'Environment import accepts bounded renderer-provided file contents from drag/drop or falls back to a JSON or .env picker, then validates native or Postman JSON environments or parses .env variables without trusting renderer-supplied paths.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js', 'src/core/import-export/environmentFormats.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/environmentFormats.test.js']),
  ipcChannel('environment:export', 'renderer-to-main', 'Environment export validates environment payloads and writes native PostMeter JSON, Postman JSON, or .env files through a main-process save picker.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js', 'src/core/import-export/environmentFormats.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/environmentFormats.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('request:import', 'renderer-to-main', 'Standalone request import accepts direct pasted text, bounded renderer-provided file contents, or a main-process picker result, then validates curl or native PostMeter request JSON before returning an unsaved request payload.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js', 'src/core/import-export/requestFormats.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/requestFormats.test.js']),
  ipcChannel('request:export', 'renderer-to-main', 'Standalone request export validates request payloads and writes native PostMeter request JSON or curl through a main-process save picker.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js', 'src/core/import-export/requestFormats.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/requestFormats.test.js']),
  ipcChannel('request:exportText', 'renderer-to-main', 'Standalone request export preview validates request payloads and returns native PostMeter request JSON or curl text for copyable renderer display.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'src/core/import-export/requestFormats.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/requestFormats.test.js']),
  ipcChannel('request:validate', 'renderer-to-main', 'Single request validation validates request and environment payloads.', ['electron/ipc/requestIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/requestIpc.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('request:send', 'renderer-to-main', 'Single request send validates request/environment payloads and validates response payloads before returning.', ['electron/ipc/requestIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/requestIpc.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('diagnostics:export', 'renderer-to-main', 'Diagnostic export opens a main-process save dialog and writes a sanitized local bundle only to the selected path.', ['electron/ipc/diagnosticsIpc.js', 'electron/app-shell/preload.js', 'src/core/diagnostics-release/diagnostics.js'], ['test/electron/diagnosticsIpc.test.js', 'test/electron/diagnostics.test.js']),
  ipcChannel('file-export:choosePath', 'renderer-to-main', 'Picker-first export opens a save dialog from lightweight metadata before expensive export preparation.', ['electron/ipc/exportIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js'], ['test/electron/exportIpc.test.js']),
  ipcChannel('file-export:prepare', 'renderer-to-main', 'Picker-first export preparation validates and serializes export payloads in a worker while the save dialog is open.', ['electron/ipc/exportIpc.js', 'electron/workers/exportPreparationWorker.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/exportIpc.test.js']),
  ipcChannel('file-export:writePrepared', 'renderer-to-main', 'Picker-first export writes a prepared export only to the user-selected validated save path.', ['electron/ipc/exportIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js', 'src/core/workspace/workspacePersistence.js'], ['test/electron/exportIpc.test.js']),
  ipcChannel('file-export:cancelPrepared', 'renderer-to-main', 'Picker-first export cancellation terminates active export preparation and clears prepared content if the user cancels the picker.', ['electron/ipc/exportIpc.js', 'electron/app-shell/preload.js'], ['test/electron/exportIpc.test.js']),
  ipcChannel('file-binding:choose', 'renderer-to-main', 'File binding picker records local attachment paths through a main-process native file dialog and returns renderer-safe metadata only.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'src/core/http/fileAttachmentBindings.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/fileAttachmentBindings.test.js']),
  ipcChannel('file-binding:storeContent', 'renderer-to-main', 'File binding content import stores bounded renderer-provided file bytes in a main-owned temporary binding and returns renderer-safe metadata only.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'src/core/http/fileAttachmentBindings.js'], ['test/electron/localFilePickerController.test.js', 'test/electron/fileAttachmentBindings.test.js']),
  ipcChannel('local-file:storeContent', 'renderer-to-main', 'Local certificate and CSV selections store bounded renderer-provided file bytes in a main-owned temporary binding and return renderer-safe source metadata only.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'src/core/http/fileAttachmentBindings.js'], ['test/electron/localFilePickerController.test.js', 'test/electron/workspaceIpc.test.js']),
  ipcChannel('oauth:pkce:start', 'renderer-to-main', 'OAuth PKCE start validates ID, auth, environment, and strategy before flow orchestration.', ['electron/ipc/oauthIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/oauthIpc.test.js', 'test/electron/auth.test.js']),
  ipcChannel('oauth:device:start', 'renderer-to-main', 'OAuth device start validates ID, auth, and environment before flow orchestration.', ['electron/ipc/oauthIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/oauthIpc.test.js', 'test/electron/auth.test.js']),
  ipcChannel('oauth:device:cancel', 'renderer-to-main', 'OAuth device cancellation validates the flow ID before aborting.', ['electron/ipc/oauthIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/oauthIpc.test.js']),
  ipcChannel('oauth:cancel', 'renderer-to-main', 'OAuth cancellation validates the flow ID before aborting.', ['electron/ipc/oauthIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/oauthIpc.test.js']),
  ipcChannel('oauth:progress', 'main-to-renderer', 'OAuth progress events are asserted before delivery to the renderer subscription.', ['electron/main.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/oauthIpc.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('vault:metadata', 'renderer-to-main', 'Vault metadata query returns audit/secret metadata only through the trusted renderer IPC wrapper.', ['electron/main.js', 'electron/app-shell/preload.js'], ['test/electron/vaultStore.test.js']),
  ipcChannel('vault:reset', 'renderer-to-main', 'Vault reset is scoped to the active workspace vault path.', ['electron/main.js', 'electron/app-shell/preload.js'], ['test/electron/vaultStore.test.js']),
  ipcChannel('vault:bind-secret', 'renderer-to-main', 'Vault secret binding stores values parent-side without exposing vault storage paths.', ['electron/main.js', 'electron/app-shell/preload.js'], ['test/electron/vaultStore.test.js']),
  ipcChannel('vault:unset-secret', 'renderer-to-main', 'Vault secret unset removes the active workspace secret parent-side.', ['electron/main.js', 'electron/app-shell/preload.js'], ['test/electron/vaultStore.test.js']),
  ipcChannel('vault:prompt', 'main-to-renderer', 'Vault prompt events carry metadata only and never include secret values.', ['electron/ipc/vaultPrompt.js', 'electron/app-shell/preload.js'], ['test/electron/vaultPrompt.test.js', 'test/electron/vaultPromptQueue.test.js']),
  ipcChannel('vault:prompt-response', 'renderer-to-main', 'Vault prompt responses must come from the original trusted renderer sender and normalize grant decisions.', ['electron/ipc/vaultPrompt.js', 'electron/app-shell/preload.js'], ['test/electron/vaultPrompt.test.js', 'test/electron/vaultPromptQueue.test.js']),
  ipcChannel('sandbox-package:fetch', 'renderer-to-main', 'Sandbox package review fetch normalizes source URL inputs and returns bounded reviewed package metadata.', ['electron/ipc/sandboxPackageIpc.js', 'electron/app-shell/preload.js'], ['test/electron/sandboxPackageIpc.test.js', 'test/electron/sandboxPackageFetcher.test.js']),
  ipcChannel('runner:start', 'renderer-to-main', 'Collection-run start validates ID, collection, environment, capture settings, and config payloads before writing high-volume results to the reusable local runtime result store.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js', 'src/core/runtime/runtimeResultStore.js', 'src/core/workspace/resultCapturePolicy.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/ipcValidation.test.js', 'test/electron/runtimeResultStore.test.js']),
  ipcChannel('runner:cancel', 'renderer-to-main', 'Collection-run cancellation validates the active run ID before aborting.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('runner:export', 'renderer-to-main', 'Collection-run export validates result/format payloads before a main-process save picker and streams store-backed CSV/JSON/HTML exports from the current runtime result store.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js', 'src/core/contracts/ipcValidation.js', 'src/core/runtime/runtimeResultStore.js', 'src/core/import-export/resultHtmlReport.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/ipcValidation.test.js', 'test/electron/runtimeResultStore.test.js', 'test/electron/resultHtmlReport.test.js']),
  ipcChannel('runner:estimateResultStore', 'renderer-to-main', 'Collection-run result-store estimation validates runner/config payloads before returning a rough SQLite size estimate, effective available disk space, and whether the renderer must block Continue.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js', 'src/core/runtime/runtimeResultStore.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/ipcValidation.test.js', 'test/electron/runtimeResultStore.test.js']),
  ipcChannel('runner:resultPage', 'renderer-to-main', 'Collection-run result paging validates the active result ID and bounded page query before reading a renderer-sized page from the reusable runtime result store.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js', 'src/core/runtime/runtimeResultStore.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/ipcValidation.test.js', 'test/electron/runtimeResultStore.test.js']),
  ipcChannel('runner:resultDetail', 'renderer-to-main', 'Collection-run result detail lookup validates the active result ID and row index before returning one captured detail row from the reusable runtime result store.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js', 'src/core/runtime/runtimeResultStore.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/ipcValidation.test.js', 'test/electron/runtimeResultStore.test.js']),
  ipcChannel('runner:importDefinition', 'renderer-to-main', 'Runner definition import accepts bounded renderer-provided file contents from drag/drop or falls back to a JSON picker, then validates native runner payloads without trusting renderer-supplied paths.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js', 'src/core/import-export/runnerFormats.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/runnerFormats.test.js']),
  ipcChannel('runner:exportDefinition', 'renderer-to-main', 'Runner definition export validates a saved runner payload before writing native runner JSON through a main-process save picker.', ['electron/ipc/workspaceIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js', 'src/core/import-export/runnerFormats.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/workspaceIpc.test.js', 'test/electron/runnerFormats.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('runner:progress', 'main-to-renderer', 'Collection-run progress events are asserted before delivery to the renderer subscription.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('performance:start', 'renderer-to-main', 'Performance-test start validates ID, saved test payload, environment, capture settings, safety limits, and progress payloads before local execution writes high-volume samples to the reusable local runtime result store.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js', 'src/core/runtime/performanceRunner.js', 'src/core/runtime/runtimeResultStore.js', 'src/core/workspace/resultCapturePolicy.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/ipcValidation.test.js', 'test/electron/performanceRunner.test.js', 'test/electron/runtimeResultStore.test.js']),
  ipcChannel('performance:cancel', 'renderer-to-main', 'Performance-test cancellation validates the active run ID before aborting the local run.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/ipcValidation.test.js']),
  ipcChannel('performance:calibrate', 'renderer-to-main', 'Performance calibration validates a runtime ID, starts a temporary 127.0.0.1 loopback server, streams progress, and returns bounded target-rate probe plus short edge-verification results with local latency-knee rejection for local client capacity.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js', 'src/core/runtime/performanceCalibration.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/performanceCalibration.test.js']),
  ipcChannel('performance:calibrate:cancel', 'renderer-to-main', 'Performance calibration cancellation validates the active calibration ID before aborting loopback requests and closing the temporary server.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js', 'src/core/runtime/performanceCalibration.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/performanceCalibration.test.js']),
  ipcChannel('performance:import', 'renderer-to-main', 'Performance-test import accepts bounded renderer-provided file contents from drag/drop or falls back to a main-process picker constrained to native performance-test JSON files without trusting renderer-supplied paths.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js', 'src/core/import-export/performanceFormats.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/performanceRunner.test.js']),
  ipcChannel('performance:export', 'renderer-to-main', 'Performance-test export validates a saved test definition before writing native performance-test JSON through a main-process save picker.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js', 'src/core/contracts/ipcValidation.js', 'src/core/import-export/performanceFormats.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/ipcValidation.test.js', 'test/electron/performanceRunner.test.js']),
  ipcChannel('performance:exportResult', 'renderer-to-main', 'Performance-result export validates bounded run output before writing JSON, CSV, or HTML through a main-process save picker and streams store-backed exports from the current runtime result store.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/fileDialogs.js', 'src/core/contracts/ipcValidation.js', 'src/core/import-export/performanceFormats.js', 'src/core/runtime/runtimeResultStore.js', 'src/core/import-export/resultHtmlReport.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/ipcValidation.test.js', 'test/electron/performanceRunner.test.js', 'test/electron/runtimeResultStore.test.js', 'test/electron/resultHtmlReport.test.js']),
  ipcChannel('performance:estimateResultStore', 'renderer-to-main', 'Performance result-store estimation validates the saved test payload before returning a rough SQLite size estimate, effective available disk space, and whether the renderer must block Continue.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js', 'src/core/runtime/runtimeResultStore.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/ipcValidation.test.js', 'test/electron/runtimeResultStore.test.js']),
  ipcChannel('performance:resultPage', 'renderer-to-main', 'Performance result paging validates the active result ID and bounded page query before reading a renderer-sized sample page from the reusable runtime result store.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js', 'src/core/runtime/runtimeResultStore.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/ipcValidation.test.js', 'test/electron/runtimeResultStore.test.js']),
  ipcChannel('performance:resultDetail', 'renderer-to-main', 'Performance result detail lookup validates the active result ID and row index before returning one captured sample detail row from the reusable runtime result store.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js', 'src/core/runtime/runtimeResultStore.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/ipcValidation.test.js', 'test/electron/runtimeResultStore.test.js']),
  ipcChannel('performance:progress', 'main-to-renderer', 'Performance-test and calibration progress events are asserted before delivery to the renderer subscription.', ['electron/ipc/runtimeIpc.js', 'electron/app-shell/preload.js', 'src/core/contracts/ipcValidation.js'], ['test/electron/runtimeIpc.test.js', 'test/electron/ipcValidation.test.js'])
]);
...
function buildDiagnosticsPrivacyMatrix() {
  return matrix('diagnostics-privacy', 'src/core/diagnostics-release/productionSupportMatrices.js', [
    row('privacy.default-deny-request-response', 'Privacy boundary', 'Request and response URLs, query/path values, methods, status codes/categories, sizes, headers, gRPC/HTTP metadata, cookies, body aliases, GraphQL variables, form-data parts, protocol messages, script console output, and payload-derived identifiers are omitted from diagnostics by default.', 'implemented', {
      evidenceRefs: ['src/core/diagnostics-release/diagnostics.js', 'src/core/diagnostics-release/diagnosticsSettings.js', 'src/core/workspace/models.js', 'docs/TECH_SPECS.md'],
    ...
    row('privacy.redaction-engine', 'Redaction', 'Auth schemes including header-shaped and standalone Bearer/Basic/Digest/Hawk/Token/OAuth/NTLM/Negotiate tokens, comma/semicolon-delimited compound Digest-style auth parameters with optional whitespace around equals, JSON-escaped/double-escaped/nested-JSON camelCase auth-header aliases, AWS SigV4 and Akamai-style signature parameters, chained AWS query credentials adjacent to kebab-case OAuth secret assignments, assigned exact token/code/state fields, assigned and bare whitespace-only snake_case, kebab-case, camelCase, unquoted multi-word, and repeated-whitespace OAuth/token/secret fields, broad camelCase/snake_case/kebab-case token/secret/password/passwd/passphrase/credential suffix aliases, X-API-key, X-access/auth/authorization-token, CSRF/XSRF-token, JWT-token, secret-key, API-secret, subscription-key, access-key, shared-access-key, account/storage/signing/webhook/license/public key, consumer-key/secret, and OAuth-consumer-key/secret aliases, certificate passphrases, generic credential fields, sensitive object keys, bare/quoted/structured/object-array/escaped/double-escaped/nested-JSON with escaped newline/quote/backslash sequences/multi-word/multiline camelCase/snake_case/kebab-case body/bodyPreview/data/responseText/text/variables/rendered-response aliases, quoted/escaped JSON request/response context containers, plus unescaped JSON/annotated/class-style and parenthesized util-inspect URL/header/metadata array/object aliases with whitespace/colon/equals separators in diagnostic text, structured header/metadata key/name pairs with sensitive value/raw/currentValue/schema fields, cookies, JWTs including JWT-shaped URL path/query/fragment values, private keys, Windows/UNC/extended UNC and Windows device/macOS/broad POSIX local paths including file:// URLs, JSON-escaped slash URLs, JSON-escaped POSIX paths, file URLs, and mixed Windows/POSIX/URL path chains, URL credentials across supported and custom URL schemes, OAuth provider/progress error URL and path references, OAuth callback code/state params and token fragments, URL-encoded free-text OAuth/token parameter strings, bare DNS/IP/localhost transport endpoints, secret query/fragment/path params including path label/value and inline same-segment forms with encoded slashes, routed fragment path forms, single- and multi-encoded delimiter forms including recursively nested encoded wrapper params and structured key/value/raw/currentValue/example/schema-default arrays, source/UI/packaged smoke failure output, source/packaged sandbox validation child output, diagnostic event type/outcome/failure-code metadata including compact/delimiter-free token/code/state labels and one-letter token aliases, IPC handler/export failure messages, and secret-shaped IPC/export error names and codes are redacted even when a narrow request/response logging category is enabled; auth-scheme words embedded inside hyphenated values are not treated as standalone auth schemes, and URL opt-ins preserve non-sensitive query, fragment, and path context while redacting sensitive query, fragment, path label/value, inline path, routed fragment path, encoded delimiter, auth, and token values.', 'implemented', {
      evidenceRefs: ['src/core/diagnostics-release/diagnostics.js', 'electron/security/ipcSecurity.js', 'electron/ipc/diagnosticsIpc.js', 'electron/app-shell/mainWindow.js', 'scripts/smokeProcess.js', 'scripts/validateSandboxRuntime.js', 'scripts/validatePackagedAppSmoke.js'],
    ...
    row('privacy.import-reset', 'Workspace import/export', 'Imported and exported native workspaces cannot silently enable request/response diagnostic logging because local diagnostics settings live in managed workspace localsettings and are omitted from portable workspace JSON.', 'implemented', {
      evidenceRefs: ['src/core/workspace/appSettingsStore.js', 'src/core/workspace/workspaceStore.js', 'src/core/workspace/workspacePersistence.js', 'src/core/diagnostics-release/diagnosticsSettings.js'],
    ...
    row('logging.local-structured-rotation', 'Local logging', 'Structured JSONL diagnostics are local-only, level-gated, record-size capped with truncation at the configured record cap, file-size capped, and rotated with a bounded file count under the app user-data diagnostics directory.', 'implemented', {
      evidenceRefs: ['src/core/diagnostics-release/diagnostics.js', 'electron/main.js'],
    ...
    row('logging.event-coverage', 'Event coverage', 'Failed imports, sends, collection runs, OAuth flows, package fetches, vault prompts, sandbox denials, OS sandbox backend selection and required-launch failures, workspace recovery, update checks, and packaged/startup validation failures emit non-secret structured diagnostic events while preserving documented internal denial failure codes.', 'implemented', {
      evidenceRefs: ['electron/ipc/requestIpc.js', 'electron/ipc/runtimeIpc.js', 'electron/ipc/workspaceIpc.js', 'electron/ipc/oauthIpc.js', 'electron/ipc/sandboxPackageIpc.js', 'electron/ipc/vaultPrompt.js', 'electron/ipc/appIpc.js', 'electron/main.js', 'electron/app-shell/mainDiagnostics.js', 'src/core/sandbox/scriptSandbox.js', 'src/core/sandbox/osSandbox.js'],
    ...
    row('ui.workspace-controls', 'Renderer UI', 'Workspace-local diagnostics controls surface the off-by-default request/response logging categories, warn about PII/customer data, save local settings with rollback on persistence failure, and expose local export from Settings and Help.', 'implemented', {
      evidenceRefs: ['src/renderer/index.html', 'src/renderer/renderer.js', 'src/renderer/app/rendererBootstrap.js', 'src/renderer/smoke/uiRegressionSmoke.js', 'electron/app-shell/appMenu.js'],
    ...
    row('ipc.diagnostics-export', 'IPC', 'Diagnostic export is main-process owned, waits for queued local privacy-setting saves before export, uses a JSON save dialog, redacts export failure messages before they reach the renderer, returns the same bounded file-operation shape as other exports, and never exposes arbitrary file reads or upload behavior to the renderer.', 'implemented', {
      evidenceRefs: ['electron/ipc/diagnosticsIpc.js', 'electron/app-shell/preload.js', 'electron/app-shell/mainWindow.js', 'electron/security/ipcSecurity.js', 'src/core/diagnostics-release/diagnostics.js'],
    ...
    row('release.matrix-validation', 'Release validation', 'The diagnostics/privacy support matrix is generated from source, checked into docs, validated by npm scripts, and referenced by the production-readiness release gate.', 'implemented', {
      evidenceRefs: ['src/core/diagnostics-release/productionSupportMatrices.js', 'scripts/productionSupportMatrix.js', 'docs/diagnostics-privacy-matrix.json', 'src/core/diagnostics-release/productionReadinessMatrix.js', 'package.json'],
...
function buildElectronSecurityMatrix() {
  return matrix('electron-security', 'src/core/diagnostics-release/productionSupportMatrices.js', [
    row('browser-window.single-window', 'BrowserWindow', 'The app shell creates one primary BrowserWindow and recreates only that window on macOS activate.', 'implemented', {
      evidenceRefs: ['electron/main.js', 'electron/app-shell/mainWindow.js'],
    ...
    row('browser-window.webpreferences', 'BrowserWindow', 'Renderer runs with nodeIntegration disabled, contextIsolation enabled, sandbox enabled, webSecurity enabled, and insecure content disabled.', 'implemented', {
      evidenceRefs: ['electron/app-shell/mainWindow.js'],
    ...
    row('browser-window.navigation', 'Navigation', 'Renderer-controlled top-level navigation is limited to the exact initial packaged custom-protocol renderer URL; external, arbitrary file, unexpected app-protocol path, and unexpected app-protocol query navigations are denied.', 'implemented', {
      evidenceRefs: ['electron/app-shell/mainWindow.js', 'electron/app-shell/appProtocol.js'],
      tests: ['test/electron/appChrome.test.js']
    }),
    ...
    row('renderer.csp', 'Renderer', 'Renderer HTML and the custom app-content protocol both enforce a restrictive local CSP that blocks remote scripts, remote connects, object/embed content, form submission, workers, and media loading.', 'implemented', {
      evidenceRefs: ['src/renderer/index.html', 'electron/app-shell/appProtocol.js', 'docs/TECH_SPECS.md'],
    ...
    row('protocol.app-content', 'Protocol', 'The renderer is served through the secure standard postmeter-app:// custom protocol with a narrow allowlist for renderer assets, reviewed shared browser-safe core files, the app icon, and known renderer smoke query keys instead of loading the UI with file://; the handler uses no renderer fetch privilege and adds no-store, nosniff, no-referrer, and CSP response headers.', 'implemented', {
      evidenceRefs: ['electron/app-shell/appProtocol.js', 'electron/main.js', 'electron/app-shell/mainWindow.js'],
    ...
    row('external-url.app-help-allowlist', 'External URLs', 'General app/help external URL IPC only opens credential-free HTTPS GitHub URLs after payload validation.', 'implemented', {
      evidenceRefs: ['electron/ipc/appIpc.js', 'src/core/contracts/ipcValidation.js'],
    ...
    row('external-url.oauth-browser-launch', 'External URLs', 'OAuth authorization and device verification browser launches are sourced from validated OAuth URLs and rechecked for credential-free http/https at the shell boundary rather than arbitrary renderer open-external calls.', 'implemented', {
      evidenceRefs: ['electron/services/oauthFlows.js', 'src/core/http/auth.js', 'electron/ipc/oauthIpc.js'],
    ...
    row('protocol.oauth-custom-scheme', 'Protocol', 'The postmeter:// OAuth callback scheme is registered through the main process and callback URLs are accepted only for the expected oauth/callback route with an active matching OAuth state.', 'implemented', {
      evidenceRefs: ['electron/services/oauthFlows.js', 'package.json', 'scripts/validateWindowsProtocolRegistration.ps1', 'scripts/validateMacProtocolRegistration.sh'],
    ...
    row('ipc.session', 'IPC', 'Renderer session load/save channels validate persisted UI-session payloads, including the synchronous shutdown flush path.', 'implemented', {
      evidenceRefs: ['electron/ipc/sessionIpc.js', 'electron/services/sessionStore.js', 'src/core/contracts/ipcValidation.js'],
    ...
    row('ipc.workspace', 'IPC', 'Workspace and collection IPC channels validate payloads and route native file dialogs through main-process handlers.', 'implemented', {
      evidenceRefs: ['electron/ipc/workspaceIpc.js', 'electron/app-shell/fileDialogs.js', 'src/core/contracts/ipcValidation.js'],
    ...
    row('ipc.request', 'IPC', 'Single-request validation/send IPC validates request, environment, and response payloads before mutating workspace state.', 'implemented', {
      evidenceRefs: ['electron/ipc/requestIpc.js', 'src/core/contracts/ipcValidation.js'],
    ...
    row('ipc.diagnostics', 'IPC', 'Diagnostics export IPC is save-dialog-only and writes sanitized local diagnostic bundles without accepting renderer-provided paths or upload destinations.', 'implemented', {
      evidenceRefs: ['electron/ipc/diagnosticsIpc.js', 'src/core/diagnostics-release/diagnostics.js', 'electron/app-shell/preload.js'],
    ...
    row('ipc.runtime', 'IPC', 'Collection-run IPC validates start/cancel/export payloads and progress events while keeping cancellation state parent-owned.', 'implemented', {
      evidenceRefs: ['electron/ipc/runtimeIpc.js', 'src/core/contracts/ipcValidation.js'],
    ...
    row('ipc.oauth', 'IPC', 'OAuth IPC validates IDs, auth payloads, environments, and cancellation requests before entering OAuth flow orchestration.', 'implemented', {
      evidenceRefs: ['electron/ipc/oauthIpc.js', 'src/core/contracts/ipcValidation.js'],
    ...
    row('ipc.vault', 'IPC', 'Vault metadata, binding, reset, unset, and prompt-response IPC expose only bounded metadata and validated decisions to the renderer.', 'implemented', {
      evidenceRefs: ['electron/main.js', 'electron/ipc/vaultPrompt.js', 'electron/app-shell/preload.js'],
    ...
    row('ipc.sandbox-package', 'IPC', 'Sandbox package fetch IPC keeps package review/fetching parent-owned and validates reviewed source inputs before caching packages.', 'implemented', {
      evidenceRefs: ['electron/ipc/sandboxPackageIpc.js', 'src/core/sandbox/sandboxPackageCache.js'],
    ...
    row('ipc.sender-validation', 'IPC', 'All renderer-to-main IPC registrations are wrapped with trusted main-frame renderer sender validation; missing senderFrame metadata, subframes, external origins, unexpected app-protocol paths, and unexpected app-protocol query keys fail closed before handler logic runs.', 'implemented', {
      evidenceRefs: ['electron/main.js', 'electron/security/ipcSecurity.js'],
      tests: ['test/electron/appChrome.test.js']
    }),
    ...
    row('file-dialogs.workspace', 'File dialogs', 'Workspace import/export dialogs are main-process owned, use JSON filters/defaults, validate selected path shape, and validate cancellation/result payloads.', 'implemented', {
      evidenceRefs: ['electron/ipc/workspaceIpc.js', 'electron/app-shell/fileDialogs.js'],
    ...
    row('file-dialogs.collection-and-runner', 'File dialogs', 'Collection import/export and collection-run export dialogs are main-process owned, use constrained filters/default filenames, validate selected path shape, and validate cancellation/result payloads.', 'implemented', {
      evidenceRefs: ['electron/ipc/workspaceIpc.js', 'electron/ipc/runtimeIpc.js', 'electron/app-shell/fileDialogs.js'],
    ...
    row('electron.fuses-reviewed', 'Packaging', 'Electron fuse hardening is reviewed; fuses that cannot be flipped without breaking Electron-run-as-Node script workers remain documented instead of silently assumed.', 'documented-gap', {
      evidenceRefs: ['docs/SECURITY.md', 'docs/TECH_SPECS.md'],
    ...
    row('visualizer.csp', 'Visualizer', 'Visualizer iframe output remains sandboxed with CSP/reviewed asset controls and no unreviewed remote script loading.', 'implemented', {
      evidenceRefs: ['src/core/sandbox/scriptRuntime.js', 'docs/SANDBOX_CONTRACT.md'],
...
function buildWorkspaceDurabilityMatrix() {
  return matrix('workspace-durability', 'src/core/diagnostics-release/productionSupportMatrices.js', [
    row('workspace.atomic-json-writes', 'Atomic writes', 'Workspace JSON, session, and backup writes use collision-resistant same-directory temporary files, fsync file contents where supported, and directory-fsync after rename.', 'implemented', {
      evidenceRefs: ['src/core/workspace/workspacePersistence.js', 'src/core/workspace/workspaceStore.js', 'electron/services/sessionStore.js'],
    ...
    row('workspace.atomic-export-writes', 'Atomic writes', 'Workspace, collection, example, and collection-run exports write through same-directory temporary files before replacing the selected output path.', 'implemented', {
      evidenceRefs: ['src/core/workspace/workspacePersistence.js', 'src/core/workspace/workspaceStore.js', 'electron/ipc/workspaceIpc.js', 'electron/ipc/runtimeIpc.js'],
    ...
    row('workspace.corrupt-quarantine', 'Recovery', 'Unreadable workspace JSON is quarantined with a collision-resistant sibling path, the containing directory is fsynced where supported, and recovered default publication is no-overwrite so newer replacement data is preserved.', 'implemented', {
      evidenceRefs: ['src/core/workspace/workspaceStore.js', 'src/core/workspace/workspaceManager.js', 'docs/TROUBLESHOOTING.md'],
    ...
    row('workspace.managed-catalog-discovery', 'Recovery', 'Managed workspace discovery is source-of-truth filesystem discovery; stale legacy manifests, stale temp files, missing workspace files, and unrecognized existing JSON files cannot silently replace or be overwritten by default creation, create/import/rename, publication races, or active-workspace recovery.', 'implemented', {
      evidenceRefs: ['src/core/workspace/workspaceManager.js', 'docs/TECH_SPECS.md', 'docs/TROUBLESHOOTING.md'],
    ...
    row('workspace.schema-migrations', 'Migrations', 'Workspace schema migrations preserve imported Postman metadata, globals, cookies, vault grants, package cache metadata, and protocol profiles.', 'implemented', {
      evidenceRefs: ['src/core/workspace/workspaceMigrations.js', 'docs/TECH_SPECS.md'],
    ...
    row('workspace.performance-tests', 'Performance tests', 'The local V1 Performance model persists as workspace.performanceTests with schema migration, normalization, native workspace import/export round trips, request-copy isolation, safety-limit defaults, and no vault/plaintext secret leakage into Performance exports.', 'implemented', {
      evidenceRefs: ['docs/TECH_SPECS.md', 'docs/ARCHITECTURE.md', 'src/core/workspace/models.js', 'src/core/workspace/workspaceMigrations.js', 'src/core/import-export/performanceFormats.js'],
    ...
    row('workspace.side-effect-merge', 'Concurrent script effects', 'Sandbox variable/cookie side effects are merged by delta with workspace identity guards.', 'implemented', {
      evidenceRefs: ['electron/services/workspaceMutations.js'],
    ...
    row('vault.encrypted-outside-workspace', 'Vault durability', 'Vault values are encrypted outside workspace JSON, vault file rename/delete is parent-owned and no-overwrite, and vault access fails closed when OS encryption is unavailable.', 'implemented', {
      evidenceRefs: ['src/core/sandbox/vaultStore.js', 'electron/main.js'],
    ...
    row('workspace.large-workspace-budget', 'Performance budget', 'Large workspace load, save, search, collection tree render, request open, collection run setup, and import/export budgets must stay covered by focused tests before stable release.', 'implemented', {
      evidenceRefs: ['test/electron/workspaceDurabilityPerformance.test.js', 'src/renderer/smoke/uiRegressionSmoke.js', 'test/electron/uiRegressionSmoke.js'],
    ...
    row('workspace.import-export-cancel', 'Import/export recovery', 'Import/export picker cancellation and failed parse paths return explicit results without clobbering the active workspace.', 'implemented', {
      evidenceRefs: ['electron/ipc/workspaceIpc.js', 'src/core/workspace/workspaceStore.js', 'docs/TROUBLESHOOTING.md'],
      tests: ['test/electron/workspaceStore.test.js', 'test/electron/workspaceManager.test.js']
    })
  ]);
}
...
function buildNonPostmanCompatibilityMatrix() {
  return matrix('non-postman-compatibility', 'src/core/diagnostics-release/productionSupportMatrices.js', [
    row('openapi.import-export', 'OpenAPI', 'OpenAPI/Swagger JSON/YAML import and OpenAPI 3.1 export cover common local references, server variables, path/query/header/cookie parameters, Swagger 2.0 body/form-data, auth, binary body hints, and request bodies where representable.', 'implemented', {
      evidenceRefs: ['src/core/import-export/openApiFormats.js', 'docs/COMPATIBILITY.md'],
      tests: ['test/electron/collectionFormats.test.js']
    }),
    row('curl.import-export', 'curl', 'curl import/export covers common method, URL, generated names, header, auth, repeated data, query-data, cookie, redirect, compression, file/binary, and quoting variants for collections and standalone requests; generated collection shell scripts include collection/request comments and warnings for PostMeter-only request behavior that curl cannot represent.', 'implemented', {
      evidenceRefs: ['src/core/import-export/curlFormats.js', 'src/core/import-export/requestFormats.js', 'docs/COMPATIBILITY.md'],
    ...
    row('unsupported.claim-boundaries', 'Claim boundaries', 'Unsupported or preserve-only behavior is documented without claiming source-format-perfect parity.', 'implemented', {
      evidenceRefs: ['docs/COMPATIBILITY.md', 'docs/TECH_SPECS.md'],
    ...
    row('openapi.invalid-common-specs', 'OpenAPI', 'Invalid-but-common OpenAPI and structured collection variants fail with clear parser or fallback errors instead of crashing or producing misleading collections.', 'implemented', {
      evidenceRefs: ['src/core/import-export/openApiFormats.js', 'test/electron/collectionFormats.test.js'],
      tests: ['test/electron/collectionFormats.test.js']
    }),
    row('curl.cross-shell-quoting', 'curl', 'curl import/export covers common Linux/macOS/Windows quoting forms, including cmd.exe caret line continuations, and repeated headers without claiming every shell dialect.', 'implemented', {
      evidenceRefs: ['src/core/import-export/curlFormats.js', 'docs/COMPATIBILITY.md'],
      tests: ['test/electron/collectionFormats.test.js']
    })
  ]);
}
...
function buildUxAccessibilityMatrix() {
  return matrix('ux-accessibility', 'src/core/diagnostics-release/productionSupportMatrices.js', [
    ...
    row('workflow.import-export', 'Imports/exports', 'Workspace, collection, example, and runner import/export cancellation and failure paths stay parent-owned and report actionable errors without clobbering active state.', 'implemented', {
      evidenceRefs: ['electron/ipc/workspaceIpc.js', 'electron/ipc/runtimeIpc.js', 'electron/app-shell/fileDialogs.js', 'docs/TROUBLESHOOTING.md'],
    ...
    row('workflow.oauth', 'OAuth', 'OAuth PKCE and device-code UX exposes waiting, completion, cancellation, state-mismatch, provider-denial, timeout, token-failure, and redacted provider-error states.', 'implemented', {
      evidenceRefs: ['src/renderer/index.html', 'src/renderer/app/rendererWorkflows.js', 'src/renderer/smoke/uiOauthSmoke.js', 'docs/OAUTH_PROVIDER_CERTIFICATION.md'],
    ...
    row('workflow.sandbox-package-review', 'Sandbox package review', 'Package review/fetch/cache controls surface reviewed package status, missing references, fetch failure, refresh behavior, and destructive removal cancellation/success/failure rollback without installing unreviewed runtime packages.', 'implemented', {
      evidenceRefs: ['src/renderer/index.html', 'src/renderer/app/rendererWorkflows.js', 'electron/ipc/sandboxPackageIpc.js', 'src/core/sandbox/sandboxPackageCache.js'],
    ...
    row('workflow.vault-prompts', 'Vault prompts', 'Vault metadata, prompt, grant, deny, reset, unavailable-encryption, and local secret-binding states keep script-requested secret values in the main process, use masked in-app user input for local binding, and expose metadata-only script access decisions.', 'implemented', {
      evidenceRefs: ['src/renderer/index.html', 'src/renderer/app/rendererBootstrap.js', 'electron/ipc/vaultPrompt.js', 'docs/TROUBLESHOOTING.md'],
    ...
    row('workflow.settings-theme', 'Settings/theme', 'App-wide theme/update/tab/modal preferences save and reload from settings.json, while workspace-local sandbox/diagnostics settings save and reload from managed workspace localsettings without leaking into request payloads or portable workspace exports.', 'implemented', {
      evidenceRefs: ['src/core/workspace/appSettingsStore.js', 'src/renderer/index.html', 'src/renderer/styles/theme.css', 'src/renderer/renderer.js', 'src/renderer/smoke/uiWorkflowSmoke.js'],
