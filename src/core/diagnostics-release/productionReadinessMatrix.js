const STATUS_DESCRIPTIONS = Object.freeze({
  ...
  'external-validation-required': 'Implementation exists, but final evidence requires native runners, provider signoff, optional sanitized artifacts, or signing assets.',
...
function buildProductionReadinessMatrix() {
  const rows = [
    ...
    row('docs.public-release', 'docs', 'Public release docs explain readiness gates, compatibility claims, unsigned artifacts, support channel, and platform limitations.', 'validated', {
      releaseBlocking: true,
