...
function buildProductionReadinessMatrix() {
  const rows = [
    ...
    row('ux.accessibility', 'ux', 'Production user workflows, accessibility-sensitive modals, and failure states are source-matrixed, smoke-tested, artifacted, and documented before release.', 'external-validation-required', {
      ...
      evidenceRefs: ['docs/ux-accessibility-matrix.json', 'docs/TECH_SPECS.md', 'src/renderer/index.html', 'src/renderer/smoke/uiRegressionSmoke.js', 'src/renderer/smoke/uiSnapshotSmoke.js', 'test/electron/startupSmoke.js', 'scripts/smokeProcess.js', 'electron/app-shell/mainWindow.js'],
